...
RSpec.describe Rumale::Preprocessing::OrdinalEncoder do
  ...
  it 'encodes categorical features and decodes value features', :aggregate_failures do
  ...
  it 'encodes with specified categories', :aggregate_failures do
