...
RSpec.describe Rumale::PairwiseMetric do
  let(:n_samples_a) { 10 }
  let(:n_samples_b) { 5 }
  let(:samples_a) { Numo::DFloat.new(n_samples_a, 3).rand }
  let(:samples_b) { Numo::DFloat.new(n_samples_b, 3).rand }

  describe '#squared_error' do
    let(:dist_mat) { described_class.squared_error(samples_a, samples_b) }
    let(:dist_mat_bf) do
      Numo::DFloat.zeros(n_samples_a, n_samples_b).tap do |dm|
        n_samples_a.times do |m|
          n_samples_b.times do |n|
            dm[m, n] = ((samples_a[m, true] - samples_b[n, true])**2).sum
          end
        end
      end
    end

    it 'calculates the pairwise squared errors between different datasets', :aggregate_failures do
      expect(dist_mat).to be_a(Numo::DFloat)
  ...
  describe '#euclidean_distance' do
    it 'calculates the euclidean distance matrix between different datasets', :aggregate_failures do
    ...
    it 'calculates the euclidean distance matrix of dataset', :aggregate_failures do
  ...
  describe '#manhattan_distance' do
    it 'calculates the manhattan distance matrix between different datasets', :aggregate_failures do
      dist_mat_bf = Numo::DFloat.zeros(n_samples_a, n_samples_b)
      n_samples_a.times do |m|
        n_samples_b.times do |n|
    ...
    it 'calculates the manhattan distance matrix of dataset', :aggregate_failures do
      dist_mat_bf = Numo::DFloat.zeros(n_samples_a, n_samples_a)
      n_samples_a.times do |m|
        n_samples_a.times do |n|
  ...
  describe '#cosine_similarity' do
    it 'calculates the cosine similarity matrix between different datasets', :aggregate_failures do
      ...
      expect(sim_mat).to be_a(Numo::DFloat)
    ...
    it 'calculates the cosine similarity matrix of dataset', :aggregate_failures do
  ...
  describe '#cosine_distance' do
    it 'calculates the cosine distance matrix between different datasets', :aggregate_failures do
      dist_mat_bf = Numo::DFloat.zeros(n_samples_a, n_samples_b)
      n_samples_a.times do |m|
        norm_a = Math.sqrt((samples_a[m, true]**2).sum)
        norm_a = 1.0 if norm_a == 0
    ...
    it 'calculates the cosine distance matrix of dataset', :aggregate_failures do
      dist_mat_bf = Numo::DFloat.zeros(n_samples_a, n_samples_a)
      n_samples_a.times do |m|
        norm_am = Math.sqrt((samples_a[m, true]**2).sum)
        norm_am = 1.0 if norm_am == 0
  ...
  describe '#rbf_kernel' do
    ...
    it 'calculates the RBF kernel matrix of dataset', :aggregate_failures do
      ...
      expect(kernel_mat).to be_a(Numo::DFloat)
    ...
    it 'calculates the RBF kernel matrix between different datasets', :aggregate_failures do
      kernel_mat_bf = Numo::DFloat.asarray(
  ...
  describe '#linear_kernel' do
    it 'calculates the linear kernel matrix of dataset', :aggregate_failures do
      kernel_mat_bf = Numo::DFloat.asarray(
        Array(0...n_samples_a).product(Array(0...n_samples_a)).map do |m, n|
    ...
    it 'calculates the linear kernel matrix between different datasets', :aggregate_failures do
      kernel_mat_bf = Numo::DFloat.asarray(
        Array(0...n_samples_a).product(Array(0...n_samples_b)).map do |m, n|
  ...
  describe '#polynomial_kernel' do
    ...
    it 'calculates the polynomial kernel matrix of dataset', :aggregate_failures do
      kernel_mat_bf = Numo::DFloat.asarray(
        Array(0...n_samples_a).product(Array(0...n_samples_a)).map do |m, n|
    ...
    it 'calculates the polynomial kernel matrix between different datasets', :aggregate_failures do
      kernel_mat_bf = Numo::DFloat.asarray(
        Array(0...n_samples_a).product(Array(0...n_samples_b)).map do |m, n|
  ...
  describe '#sigmoid_kernel' do
    ...
    it 'calculates the sigmoid kernel matrix of dataset', :aggregate_failures do
      kernel_mat_bf = Numo::DFloat.asarray(
        Array(0...n_samples_a).product(Array(0...n_samples_a)).map do |m, n|
    ...
    it 'calculates the sigmoid kernel matrix between different datasets', :aggregate_failures do
      kernel_mat_bf = Numo::DFloat.asarray(
        Array(0...n_samples_a).product(Array(0...n_samples_b)).map do |m, n|
