...
require_relative 'lib/rumale/nearest_neighbors/version'

Gem::Specification.new do |spec|
  spec.name = 'rumale-nearest_neighbors'
  spec.version = Rumale::NearestNeighbors::VERSION
  ...
  spec.metadata['source_code_uri'] = "#{spec.homepage}/tree/main/rumale-nearest_neighbors"
