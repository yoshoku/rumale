...
RSpec.describe Rumale::MetricLearning::LocalFisherDiscriminantAnalysis do
  ...
  context 'when Numo::Linalg is not loaded' do
    ...
    it 'raises Runtime error' do
      expect { transformer.fit(x, y) }.to raise_error(RuntimeError, /LocalFisherDiscriminatAnalysis#fit requires Numo::Linalg/)
    end
  end
end
