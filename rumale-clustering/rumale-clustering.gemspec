...
require_relative 'lib/rumale/clustering/version'

Gem::Specification.new do |spec|
  spec.name = 'rumale-clustering'
  spec.version = Rumale::Clustering::VERSION
  ...
  spec.metadata['source_code_uri'] = "#{spec.homepage}/tree/main/rumale-clustering"
