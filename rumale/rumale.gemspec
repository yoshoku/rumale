...
Gem::Specification.new do |spec|
  ...
  spec.add_dependency 'rumale-clustering', '~> 2.0.0'
  spec.add_dependency 'rumale-core', '~> 2.0.0'
  spec.add_dependency 'rumale-decomposition', '~> 2.0.0'
  spec.add_dependency 'rumale-ensemble', '~> 2.0.0'
  spec.add_dependency 'rumale-evaluation_measure', '~> 2.0.0'
  spec.add_dependency 'rumale-feature_extraction', '~> 2.0.0'
  spec.add_dependency 'rumale-kernel_approximation', '~> 2.0.0'
  spec.add_dependency 'rumale-kernel_machine', '~> 2.0.0'
  spec.add_dependency 'rumale-linear_model', '~> 2.0.0'
  spec.add_dependency 'rumale-manifold', '~> 2.0.0'
  spec.add_dependency 'rumale-metric_learning', '~> 2.0.0'
  spec.add_dependency 'rumale-model_selection', '~> 2.0.0'
  spec.add_dependency 'rumale-naive_bayes', '~> 2.0.0'
  spec.add_dependency 'rumale-nearest_neighbors', '~> 2.0.0'
  spec.add_dependency 'rumale-neural_network', '~> 2.0.0'
  spec.add_dependency 'rumale-pipeline', '~> 2.0.0'
