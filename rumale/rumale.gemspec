...
Gem::Specification.new do |spec|
  ...
  spec.add_dependency 'rumale-clustering', '~> 0.24.0'
  spec.add_dependency 'rumale-core', '~> 0.24.0'
  spec.add_dependency 'rumale-decomposition', '~> 0.24.0'
  spec.add_dependency 'rumale-ensemble', '~> 0.24.0'
  spec.add_dependency 'rumale-evaluation_measure', '~> 0.24.0'
  spec.add_dependency 'rumale-feature_extraction', '~> 0.24.0'
  spec.add_dependency 'rumale-kernel_approximation', '~> 0.24.0'
  spec.add_dependency 'rumale-kernel_machine', '~> 0.24.0'
  spec.add_dependency 'rumale-linear_model', '~> 0.24.0'
  spec.add_dependency 'rumale-manifold', '~> 0.24.0'
  spec.add_dependency 'rumale-metric_learning', '~> 0.24.0'
  spec.add_dependency 'rumale-model_selection', '~> 0.24.0'
  spec.add_dependency 'rumale-naive_bayes', '~> 0.24.0'
  spec.add_dependency 'rumale-nearest_neighbors', '~> 0.24.0'
  spec.add_dependency 'rumale-neural_network', '~> 0.24.0'
  spec.add_dependency 'rumale-pipeline', '~> 0.24.0'
